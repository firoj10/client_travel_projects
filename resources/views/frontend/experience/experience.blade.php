...
<head>
    ...
    <style>
        .container {
            position: relative;
            /* Ensure this is the parent of the positioned element */
        }
        ...
        .centered-content {
            ...
            text-align: center;
            width: calc(100% - 48px);
            /* Adjust width to fit container, considering left positioning */
        }
    ...
    <section class="about-banner" style="background-image: url('{{ asset('frontend/img/banner_experience.png') }}')">
        <div class="container-fluid">
            <div class="about-content text-center">
                ...
                <p><span class="fw-semibold  white-color">Find the best & the reliable resorts to get an unforgettable holiday 
                    experience in the tropical paradise of the Maldives. </span>
                </p>
            </div>
        </div>
    </section>
