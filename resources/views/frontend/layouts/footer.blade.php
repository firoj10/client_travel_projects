    ...
    <div class="container-fluid text-lg-start text-md-start text-sm-center text-center">
        <div class="row">
            <div class="col-lg-4 col-md-12 mb-2">
                <img src="{{ asset('frontend/img/11.png') }}" alt="" class="img-fluid"
                    width="20%">
                ...
                <div class="d-flex align-items-center">
                  ...
                  font-size: 20px;" aria-hidden="true"
                    ...
                    </svg><!-- <i class="fa-solid fa-location-dot me-3" style="color: #FD003A;
                  font-size: 20px;"></i> Font Awesome fontawesome.com -->
                ...
                <div
                    ...
                    <img src="https://holidayslinkmaldives.com/assets/img/calls.png')}}" alt=""
                        class="me-3 " style="width:20px;">
                    <p class="m-0 me-3"><a>+960-9506464</a>
                    </p>
                    <div class="d-flex align-items-center">
                        <img src="https://holidayslinkmaldives.com/assets/img/wpp.png')}}" alt=""
                            class="me-3 " style="width:20px;">
                ...
                <div class="social-icons">
                    ...
                    <a target="_blank" aria-label="Tiktok"><svg class="svg-inline--fa fa-tiktok"
                        ...
                        </svg><!-- <i class="fa-brands fa-tiktok"></i> Font Awesome fontawesome.com --></a>
