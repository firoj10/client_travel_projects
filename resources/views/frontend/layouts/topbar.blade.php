    ...
    <div class="d-lg-flex d-md-flex d-sm-block justify-content-between text-cnt">
        <div class="d-lg-flex  d-md-flex d-sm-block align-items-center text-cnt">
            ...
            <div class="fab_icons_div  px-2">
                ...
                <span > <a href=""class="text-white">Vtravels, Hulhumale </a> </span>
            </div>
        </div>
        <div class="d-lg-flex fab_icons_div  d-md-flex d-lg-block d-md-block d-sm-none d-none">
            <span class="">English</span>
            <img src="{{asset('frontend/img/topicon/en.png')}}" alt="country flag">
            <div class="social-icons icons_links ms-4">
                ...
                <a href="" target="_blank" aria-label="YouTube"><img
                        src="{{asset('frontend/img/topicon/yt.png')}}" alt="fb"
                        class="img-fluid"></a>
                <a href="" target="_blank" aria-label="Instagram"><img
                        src="{{asset('frontend/img/topicon/inst.png')}}" alt="fb"
                        class="img-fluid"></a>
                <a href="" target="_blank" aria-label="WhatsApp"><img
                        src="{{asset('frontend/img/topicon/whatsapp.png')}}" alt="fb"
                        class="img-fluid"></a>
                <a href="" target="_blank" aria-label="Tiktok"><img
                        src="{{asset('frontend/img/topicon/header-icon-tiktok.png')}}"
