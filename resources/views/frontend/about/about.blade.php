        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-3 col-md-6 text-center">
                    <svg style="width: 40px" class="svg-inline--fa fa-handshake primary-color fs-1" aria-hidden="true"
                        focusable="false" data-prefix="far" data-icon="handshake" role="img"
                ...
                <div class="col-lg-3 col-md-6 text-center border-left" style="border-left: 0.5px dotted #666666;">
                    <svg style="width: 40px" class="svg-inline--fa fa-box primary-color fs-1" aria-hidden="true"
                        focusable="false" data-prefix="fas" data-icon="box" role="img"
                ...
                <div class="col-lg-3 col-md-6 text-center border-left border-right"
                    ...
                    <svg style="width: 40px" class="svg-inline--fa fa-hand-holding-dollar primary-color fs-1"
                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="hand-holding-dollar"
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <svg style="width: 40px" class="svg-inline--fa fa-headphones primary-color fs-1" aria-hidden="true"
                        focusable="false" data-prefix="fas" data-icon="headphones" role="img"
            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <p class="mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                        ...
                        took a galley of type and scrambled it to make a type specimen book. It has survived not only
                        five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.
                        It was popularisedm</p>
                </div>
                <div class="col-lg-5">
                    <img src="{{ asset('frontend/img/about/about1.png') }}" alt="" class="" width="100%"
                        height="100%">
            ...
            <div class="row my-5 flex-row-reverse">
                <div class="col-lg-7">
                    ...
                    <p class="mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                        Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer
                        took a galley of type and scrambled it to make a type specimen book. It has survived not only
                 lishing software like Aldus PageMaker including
                        versions of Lorem Ipsum.</p>
                </div>
                <div class="col-lg-5">
