    ...
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center home_photos_section">
            <div class="col wow fadeIn text-center" data-wow-duration="2s" data-wow-delay="0.1s"
                ...
                <img src="{{ asset('frontend/img/logos/photo-2.png') }}" alt=""
            ...
            {{-- <div class="col wow fadeIn text-center" data-wow-duration="2s" data-wow-delay="0.1s"
                style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                <img src="{{ asset('frontend/img/logos/photo-4.png') }}" alt="" class="img-fluid ">
            </div> --}}
        </div>
    </div>
</section>
...
<section class="trusted_partners">
    <div class="container-fluid">
        <div class="partner-heading text-center">
            ...
            <img src="{{ asset('frontend/img/resorts/subtitle-vector.png') }}" alt="vector"
                class="img-fluid">
        </div>
                    ...
                    <div class="">
                        <div id="carouselLogos" class="carousel slide pt-5 pb-4 pointer-event"
                            ...
                            <ol class="carousel-indicators position-relative mt-3 d-none">
                                ...
                                <li data-bs-target="#carouselLogos" data-bs-slide-to="1"
                                    class="bg-dark active" aria-current="true">
                                </li>
                            </ol>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.1s"
                ...
                <div class="booking-heading text-center">
                    ...
                    <img src="{{ asset('frontend/img/step/Vector-sub.png') }}" alt="vector"
                        class="img-fluid">
                </div>
                <div class="row pt-5 justify-content-between">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 d-flex ">
                        <div class="me-3">
                            ...
                            <img src="{{ asset('frontend/img/step/loc.png') }}" alt="loc"
                                style="width:50px;">
                        </div>
                        <div>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 d-flex ">
                        <div class="me-3">
                            <img src="{{ asset('frontend/img/step/chat.png') }}" alt="chat"
                                style="width:50px;">
...
<section class="certificate_license py-3">
    <div class="container-fluid wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s"
        ...
        <div class="certificate-heading text-center">
            ...
            <img src="{{ asset('frontend/img/resorts/subtitle-vector.png') }}" alt=""
                class="img-fluid">
        </div>
        ...
        <div class="col-md-12">
            <div class="lc-block">
                <div id="carouselAirline" class="carousel slide pt-5 pb-4 pointer-event"
                    data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner px-5">
                        ...
                        <div class="carousel-item active">
                            <div class="row justify-content-center">
                                <div class="col-6 col-lg-2 align-self-center">
                                    <img class="d-block w-100  mb-3"
                                        src="{{ asset('frontend/img/license/certificates-9.png') }}"
                                        alt="">
                                </div>
                                <div class="col-6 col-lg-2 align-self-center">
                                    <img class="d-block w-100  mb-3"
                                        src="{{ asset('frontend/img/license/certificates-14.png') }}"
                                        alt="">
                                </div>
                                <div class="col-6 col-lg-2 align-self-center">
                                    <img class="d-block w-100  mb-3"
                                        src="{{ asset('frontend/img/license/certificates-13.png') }}"
                                        alt="">
                                </div>
                                <div class="col-6 col-lg-2 align-self-center">
                                    <img class="d-block w-100  mb-3"
                                        src="{{ asset('frontend/img/license/certificates-12.png') }}"
                                        alt="">
                                </div>
                                <div class="col-6 col-lg-2 align-self-center">
                                    <img class="d-block w-100  mb-3"
                                        src="{{ asset('frontend/img/license/certificates-11.png') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="accordion-item rounded my-3">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button"
                                data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne1"
                                aria-expanded="true" aria-controls="panelsStayOpen-collapseOne1">
                    ...
                    <div class="accordion-item rounded my-3">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button"
                                ...
                                aria-expanded="true" aria-controls="panelsStayOpen-collapseOne2">
